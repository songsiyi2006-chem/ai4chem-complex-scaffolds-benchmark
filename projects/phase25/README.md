...
- [PHASE25_PROGRESS_EN.md](reports/PHASE25_PROGRESS_EN.md)
- [PHASE25_PROGRESS_ZH.md](reports/PHASE25_PROGRESS_ZH.md)
- [PHASE25_REPORT_EN.md](reports/PHASE25_REPORT_EN.md)
- [PHASE25_REPORT_ZH.md](reports/PHASE25_REPORT_ZH.md)
...
```sh
python projects/phase25/run.py --workspace work/runs/phase25 --prepare-only
```
