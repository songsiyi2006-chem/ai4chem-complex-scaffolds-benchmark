...
![E/Z 与低频敏感性](../results/figures/imine_EZ_sensitivity.png)
...
![完整三组分结构与接触距离](../results/figures/ternary_minimum.png)
...
[计算进展](../results/pilot_progress.json) · [原始 xTB 作业](../results/xtb_pilot) · [独立频率核查](../results/xtb_pilot/validation.json) · [三组分诊断](../results/ternary_diagnostics.json) · [原生热化学对照](../results/thermo_sensitivity/results.json) · [DFT 优化](../results/stationary_pilot/pbe_E_opt_01/result.json) · [梯度冻结快照](../results/hessian_checkpoint_snapshot/manifest.json) · [本地运行快照](../results/local_execution_snapshot.json) · [发布排除项](../../../shared/phase25_27/results/publication_omissions.json) · [复现说明](../../../shared/phase25_27/code/phase25_27/README.md)。
