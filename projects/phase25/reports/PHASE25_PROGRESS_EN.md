...
![E/Z cutoff sensitivity](../results/figures/imine_EZ_sensitivity.png)
...
![Complete optimized ternary and contacts](../results/figures/ternary_minimum.png)
...
[Progress data](../results/pilot_progress.json), [raw xTB jobs](../results/xtb_pilot), [independent audit](../results/xtb_pilot/validation.json), [ternary diagnostics](../results/ternary_diagnostics.json), [native thermochemistry](../results/thermo_sensitivity/results.json), [DFT optimization](../results/stationary_pilot/pbe_E_opt_01/result.json), [frozen native gradients](../results/hessian_checkpoint_snapshot/manifest.json), [execution snapshot](../results/local_execution_snapshot.json), [publication omissions](../../../shared/phase25_27/results/publication_omissions.json), [commands and limits](../../../shared/phase25_27/code/phase25_27/README.md).
