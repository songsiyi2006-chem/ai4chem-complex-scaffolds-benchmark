...
- [PHASE8_PREFLIGHT_NOTES.md](reports/PHASE8_PREFLIGHT_NOTES.md)
- [PHOTOCHEMISTRY_REPORT_EN.md](reports/PHOTOCHEMISTRY_REPORT_EN.md)
- [PHOTOCHEMISTRY_REPORT_ZH.md](reports/PHOTOCHEMISTRY_REPORT_ZH.md)
...
```sh
python projects/phase08/run.py --workspace work/runs/phase08 --prepare-only
```
