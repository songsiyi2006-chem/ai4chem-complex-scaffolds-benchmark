...
- [PHASE27_REPORT_EN.md](reports/PHASE27_REPORT_EN.md)
- [PHASE27_REPORT_ZH.md](reports/PHASE27_REPORT_ZH.md)
...
```sh
python projects/phase27/run.py --workspace work/runs/phase27 --prepare-only
```
