...
The [preregistered protocol](../results/protocol.json) proposes excitation windows 380–400, 440–460 and 510–530 nm. These are design choices. Initial states must be selected from calculated oscillator strengths and the actual pump spectrum; a uniform choice among electronic roots is not an excitation model.
