...
The [analysis implementation](../../../shared/phase25_27/code/phase25_27/analysis.py) rejects missing electron numbers, inconsistent charge signs and potential deviations beyond 0.05 V. It returns a pointwise Legendre audit, **not a solvent activation PMF**. The electronic chemical potential must be aligned with the actual electrostatic calibration at every point, not inferred by a universal vacuum-reference constant without checking the solvent model.
