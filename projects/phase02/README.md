...
- [DYNAMICS_REPORT_EN.md](reports/DYNAMICS_REPORT_EN.md)
- [DYNAMICS_REPORT_ZH.md](reports/DYNAMICS_REPORT_ZH.md)
...
```sh
python projects/phase02/run.py --workspace work/runs/phase02 --prepare-only
```
