...
Pipeline: [`run_phase17_relativistic_actinide_quantum.py`](../code/run_phase17_relativistic_actinide_quantum.py) · Record: [`results_phase17/phase17_results.json`](../results/phase17_results.json) · 中文版：[`RELATIVISTIC_QUANTUM_REPORT_ZH.md`](RELATIVISTIC_QUANTUM_REPORT_ZH.md)
