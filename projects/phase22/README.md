...
- [MOLECULAR_SPIN_QUBIT_REPORT_EN.md](reports/MOLECULAR_SPIN_QUBIT_REPORT_EN.md)
- [MOLECULAR_SPIN_QUBIT_REPORT_ZH.md](reports/MOLECULAR_SPIN_QUBIT_REPORT_ZH.md)
...
- [结果](results/)
- [图表](figures/)
- [依赖：requirements_phase22.txt](requirements_phase22.txt)
...
```sh
python projects/phase22/run.py --workspace work/runs/phase22 --prepare-only
```
