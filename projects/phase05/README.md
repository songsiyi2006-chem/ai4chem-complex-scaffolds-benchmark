...
- [WORLD_MODEL_REPORT_EN.md](reports/WORLD_MODEL_REPORT_EN.md)
- [WORLD_MODEL_REPORT_ZH.md](reports/WORLD_MODEL_REPORT_ZH.md)
...
```sh
python projects/phase05/run.py --workspace work/runs/phase05 --prepare-only
```
