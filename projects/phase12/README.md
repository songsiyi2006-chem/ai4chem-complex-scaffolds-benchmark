...
- [PHASE12_CHECKPOINT_NOTES.md](reports/PHASE12_CHECKPOINT_NOTES.md)
- [SCIENTIFIC_AGI_MANIFESTO_EN.md](reports/SCIENTIFIC_AGI_MANIFESTO_EN.md)
- [SCIENTIFIC_AGI_MANIFESTO_ZH.md](reports/SCIENTIFIC_AGI_MANIFESTO_ZH.md)
...
```sh
python projects/phase12/run.py --workspace work/runs/phase12 --prepare-only
```
