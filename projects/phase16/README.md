...
- [MEGAMACHINE_CRYOM_REPORT_EN.md](reports/MEGAMACHINE_CRYOM_REPORT_EN.md)
- [MEGAMACHINE_CRYOM_REPORT_ZH.md](reports/MEGAMACHINE_CRYOM_REPORT_ZH.md)
...
```sh
python projects/phase16/run.py --workspace work/runs/phase16 --prepare-only
```
