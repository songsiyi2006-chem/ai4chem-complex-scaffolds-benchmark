...
- [COMPLEX_DYNAMICS_REPORT_EN.md](reports/COMPLEX_DYNAMICS_REPORT_EN.md)
- [COMPLEX_DYNAMICS_REPORT_ZH.md](reports/COMPLEX_DYNAMICS_REPORT_ZH.md)
- [PHASE3_CHECKPOINT_NOTES.md](reports/PHASE3_CHECKPOINT_NOTES.md)
...
```sh
python projects/phase03/run.py --workspace work/runs/phase03 --prepare-only
```
