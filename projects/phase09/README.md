...
- [SELF_DRIVING_LAB_REPORT_EN.md](reports/SELF_DRIVING_LAB_REPORT_EN.md)
- [SELF_DRIVING_LAB_REPORT_ZH.md](reports/SELF_DRIVING_LAB_REPORT_ZH.md)
...
```sh
python projects/phase09/run.py --workspace work/runs/phase09 --prepare-only
```
