...
- [BENCHMARK_REPORT_EN.md](reports/BENCHMARK_REPORT_EN.md)
- [BENCHMARK_REPORT_ZH.md](reports/BENCHMARK_REPORT_ZH.md)
...
```sh
python projects/phase01/run.py --workspace work/runs/phase01 --prepare-only
```
