...
Pipeline: [`run_phase18_wholecell_metabolic_thermodynamics.py`](../code/run_phase18_wholecell_metabolic_thermodynamics.py) · Record: [`results_phase18/phase18_results.json`](../results/phase18_results.json) · 中文版：[`WHOLE_CELL_METABOLISM_REPORT_ZH.md`](WHOLE_CELL_METABOLISM_REPORT_ZH.md)
