...
- [WHOLE_CELL_METABOLISM_REPORT_EN.md](reports/WHOLE_CELL_METABOLISM_REPORT_EN.md)
- [WHOLE_CELL_METABOLISM_REPORT_ZH.md](reports/WHOLE_CELL_METABOLISM_REPORT_ZH.md)
...
```sh
python projects/phase18/run.py --workspace work/runs/phase18 --prepare-only
```
