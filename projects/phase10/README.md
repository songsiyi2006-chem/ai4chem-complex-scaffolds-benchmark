...
- [FLOW_CYBERPHYSICAL_REPORT_EN.md](reports/FLOW_CYBERPHYSICAL_REPORT_EN.md)
- [FLOW_CYBERPHYSICAL_REPORT_ZH.md](reports/FLOW_CYBERPHYSICAL_REPORT_ZH.md)
...
```sh
python projects/phase10/run.py --workspace work/runs/phase10 --prepare-only
```
