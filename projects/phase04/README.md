...
- [PHASE4_NEB_DIAGNOSTIC.md](reports/PHASE4_NEB_DIAGNOSTIC.md)
- [SKELETAL_EDITING_REPORT_EN.md](reports/SKELETAL_EDITING_REPORT_EN.md)
- [SKELETAL_EDITING_REPORT_ZH.md](reports/SKELETAL_EDITING_REPORT_ZH.md)
...
```sh
python projects/phase04/run.py --workspace work/runs/phase04 --prepare-only
```
