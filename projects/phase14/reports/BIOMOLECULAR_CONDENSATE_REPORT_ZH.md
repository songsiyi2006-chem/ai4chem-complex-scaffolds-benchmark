...
流水线：[`run_phase14_active_matter_condensate_phase_separation.py`](../code/run_phase14_active_matter_condensate_phase_separation.py) · 机器可读记录：[`results_phase14/phase14_results.json`](../results/phase14_results.json) · 图件（300 DPI）：[`figures_phase14/`](../figures)
