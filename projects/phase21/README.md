...
- [POLARITON_CHEMISTRY_REPORT_EN.md](reports/POLARITON_CHEMISTRY_REPORT_EN.md)
- [POLARITON_CHEMISTRY_REPORT_ZH.md](reports/POLARITON_CHEMISTRY_REPORT_ZH.md)
...
- [结果](results/)
- [图表](figures/)
- [依赖：requirements_phase21.txt](requirements_phase21.txt)
...
```sh
python projects/phase21/run.py --workspace work/runs/phase21 --prepare-only
```
