# 历史首页存档 / Historical README

> 本文保存整理前的首页正文，来源提交：`deb53181f8a87d56626c69106653835de953817c`。
> 其中历史数值、宣传性表述、运行状态与环境路径不是新的验收结论。
> 请先阅读[新首页](../../README.md)、[证据说明](../EVIDENCE.md)与对应阶段的更正记录。
> Original body retained below for provenance; historical claims are not revalidated by this archive.
...
**新增本地实算：** 完整 117 原子催化三组分复合物的 xTB 优化/频率、两种溶剂中的亚胺计算、DFT 驻点优化，以及可恢复的 DFT Hessian 梯度检查点。[中文进展报告](../../projects/phase25/reports/PHASE25_PROGRESS_ZH.md) · [English progress report](../../projects/phase25/reports/PHASE25_PROGRESS_EN.md) · [本轮数据快照](../../projects/phase25/results/pilot_progress.json)。仍在运行和排队的项目不计作完成。

**新增工具已实测：** [中文适用性核查](../../shared/phase25_27/results/tool_capability_audit/REPORT_ZH.md) · [English resource audit](../../shared/phase25_27/results/tool_capability_audit/REPORT_EN.md)：铜模型能量/力一致性、PubChem 供氢体身份、铜晶体来源、Ni 基组及 750 条 ORD 记录范围；这些检查不替代科学验收。
...
|---|---|---|---|
|25 · 不对称催化|[最新中文](../../projects/phase25/reports/PHASE25_PROGRESS_ZH.md)|[Latest English](../../projects/phase25/reports/PHASE25_PROGRESS_EN.md)|Complete ternary xTB minima; DFT optimization and ongoing Hessian; **选择性未判定**|
|26 · 恒电位Cu界面|[中文](../../projects/phase26/reports/PHASE26_REPORT_ZH.md)|[English](../../projects/phase26/reports/PHASE26_REPORT_EN.md)|48-condition design; 3 dry slab seeds; no sampled interfaces|
|27 · Ni光动力学|[中文](../../projects/phase27/reports/PHASE27_REPORT_ZH.md)|[English](../../projects/phase27/reports/PHASE27_REPORT_EN.md)|6-member design; original full Ni coordinates; no new trajectories|

[Results and provenance / 结果与来源](../../shared/phase25_27/results/README.md) · [Acceptance ledger / 逐条验收](../../shared/phase25_27/results/acceptance.json) · [Reproduce / 复现](../../shared/phase25_27/code/phase25_27/README.md) · [24 checks / 检查记录](../../shared/phase25_27/results/software_validation.json) · [Frozen DFT gradient evidence / 梯度证据快照](../../projects/phase25/results/hessian_checkpoint_snapshot/manifest.json)

<!-- phase25-27-evidence-end -->

## Phase 1–19 fresh reruns / 本轮重新计算（持续更新）

[显性问题收尾清单 / Closeout checklist](../../shared/audit/reports/PHASE1_19_CLOSEOUT.md)：区分已冻结阶段、已修软件缺陷、排队重算和仍未通过的科学指标；不是全阶段完成声明。

[新增工具适用性核验](../../shared/audit/reports/NEW_TOOL_APPLICABILITY_20260911.md)：geomeTRIC 已用于 Phase4 独立精修并通过驻点/单虚频检查（IRC 未验证）；列出新增模型与数据集的实际用途和限制。

修复代码与本轮独立运行的证据已分开记录，**不代表全部阶段通过**。查看 [逐阶段状态](../../shared/audit/reports/PHASE1_19_RERUN_STATUS.md)、[公开核验证据](../../shared/audit/evidence/phase1_19_rerun_20260910/README.md) 和 [命令、源码与结果哈希](../../shared/audit/evidence/phase1_19_rerun_20260910/manifest.json)。其中包括失败和采样不足的结果；下方旧审计说明及历史图表不自动等于本轮结果。
...
- [Complete standalone Python script](../../projects/phase24/code/run_ai_hts_platform_pilot.py): 48 chiral structures, 9,216 conditions, 24 MaxMin seeds and three 96-well GP/qEI batches; calibrated synthetic HPLC integration and SQLite ingestion.
- [中文综合技术报告](../../projects/phase24/reports/PHASE24_GXNU_AI_HTS_REPORT_ZH.md) · [中文两页式决策摘要](../../projects/phase24/reports/GXNU_AI_HTS_PLATFORM_PROPOSAL_ZH.md) · [English executive brief](../../projects/phase24/reports/GXNU_AI_HTS_PLATFORM_PROPOSAL_EN.md).
- [Metrics](../../projects/phase24/results/metrics.json) · [plate map](../../projects/phase24/results/plate_round3.csv) · [OT-2 API 2.15 protocol](../../projects/phase24/code/output_hts_96well_screening.py) · [artifact audit](../../projects/phase24/results/artifact_validation.json) · [official simulator validation](../../projects/phase24/results/opentrons_validation.json).
...
![Phase 24 simulated plate forecasts and measurements](../../projects/phase24/figures/fig2_96well_plate_heatmap_yield_ee.png)

> **Phase 18–19 audit / 审计更正 (2026-09-10):** Phase 18 fully recalculated; Phase 19 isolated QM scans recalculated only, NOT full enzyme evolution. Phase 18 已全流程重算；Phase 19 仅重算孤立片段，不支持历史催化速率或五代进化结论。 [Fixes, current results and limitations / 修复、重算结果与限制](../../shared/audit/reports/PHASE18_19_AUDIT_FIXES.md).

> **Phase 1–5 audit correction / 审计更正：** Related historical numerical claims below are not post-fix validated results. Code defects have been corrected, but full scientific calculations have not been rerun. 相关历史数值未完成修复后重算，不应作为已验证结论。 See [audit, limitations and rerun instructions](../../shared/audit/reports/PHASE1_5_AUDIT_FIXES.md).

> **Phase 6–10 audit correction / 审计更正：** Six targeted code defects corrected; 7 new regression tests pass. Historical figures, cached results, robot protocols and trained policies have not been regenerated or revalidated. 六项代码问题已修复，历史结果尚未重算；真实设备使用前仍须验证。 See [fixes and validation scope](../../shared/audit/reports/PHASE6_10_AUDIT_FIXES.md).

> **Phase 11–13 audit correction / 审计更正：** Wavefunction consistency, scalar diagnostics and PCET normalization/sign corrected. Historical numerical results and neural checkpoints have not been regenerated. 六项问题已修复，历史结果与神经网络训练尚未重算。 See [fixes and test limitations](../../shared/audit/reports/PHASE11_13_AUDIT_FIXES.md).

> **Phase 14–17 audit correction / 审计更正：** Reduced dissipation units, spin survival, WHAM/latch energies, LJ forces, transport references/SI conversion and exchange-energy consistency corrected. Historical production results have not been regenerated. 历史图表及数值尚未重算，不能视为修复后验证结果。 See [fixes and validation limits](../../shared/audit/reports/PHASE14_17_AUDIT_FIXES.md).

# AI4Chem — Complex Scaffolds Benchmark

## Phase 23: molecular memristors and in-materio reservoir computing

[![Phase 23 code](https://img.shields.io/badge/Phase_23-In_materio_computing-blue)](../../projects/phase23/code/run_phase23_in_materio_neuromorphic_computing.py)
[![Model scope](https://img.shields.io/badge/Evidence-Effective_model-grey)](../../projects/phase23/reports/IN_MATERIO_COMPUTING_REPORT_EN.md)
...
Reports: [English](../../projects/phase23/reports/IN_MATERIO_COMPUTING_REPORT_EN.md) / [中文](../../projects/phase23/reports/IN_MATERIO_COMPUTING_REPORT_ZH.md).
Data and validation: [`results_phase23/summary.json`](../../projects/phase23/results/summary.json).

![Phase 23 reservoir preview](../../projects/phase23/figures/fig3_in_materio_chaotic_reservoir_tracking.png)

## Phase 22: molecular spin qubits and clock-transition protection

[![Phase 22 code](https://img.shields.io/badge/Phase_22-Spin_qubits-blue)](../../projects/phase22/code/run_phase22_molecular_spin_qubits.py)
[![Phase 22 reports](https://img.shields.io/badge/Reports-EN_%7C_ZH-grey)](../../projects/phase22/reports/MOLECULAR_SPIN_QUBIT_REPORT_EN.md)
...
Reports: [English](../../projects/phase22/reports/MOLECULAR_SPIN_QUBIT_REPORT_EN.md) / [中文](../../projects/phase22/reports/MOLECULAR_SPIN_QUBIT_REPORT_ZH.md).
Data/checks: [`results_phase22/summary.json`](../../projects/phase22/results/summary.json).

![Phase 22 coherence preview](../../projects/phase22/figures/fig3_dynamical_decoupling_coherence_gain.png)
...
Reports: [English](../../projects/phase21/reports/POLARITON_CHEMISTRY_REPORT_EN.md) / [中文](../../projects/phase21/reports/POLARITON_CHEMISTRY_REPORT_ZH.md).
Data and validation: [`results_phase21/summary.json`](../../projects/phase21/results/summary.json).
Figures: [`figures_phase21/`](../../projects/phase21/figures).
...
Results: [`results_phase20/summary.json`](../../projects/phase20/results/summary.json), CSV data,
SHA-256 manifest and four 300 DPI plots in [`figures_phase20/`](../../projects/phase20/figures).
Reports: [English](../../projects/phase20/reports/CISS_QUANTUM_SPINTRONICS_REPORT_EN.md) /
[中文](../../projects/phase20/reports/CISS_QUANTUM_SPINTRONICS_REPORT_ZH.md).
...
![Phase 13](https://img.shields.io/badge/Phase%2013-bioinorganic%20PCET%20%C2%B7%20proton%20tunneling%20%C2%B7%20spectroscopic%20twin-E74C3C)
...
![Phase 19](https://img.shields.io/badge/Phase%2019-active%20inference%20de%20novo%20enzyme%20%C2%B7%20Kemp%20eliminase-9B59B6)

## Mission

**Nineteen-phase master architecture (the Pantheon) — from silicon prediction through embodied execution, the relativistic and quantum-biological frontiers, to the autonomous design of non-natural enzymatic life.**
...
**Phase 2 — Heavy dynamics suite.** Five next-generation med-chem targets (CRBN molecular glue, ADC Val-Cit-PAB linker, bicyclic disulfide peptidomimetic, allosteric covalent inhibitor core, VHL-mimetic hybrid) advance into **relaxed torsional barrier scanning** (36-point MMFF94 scans, ΔE‡ = 7.8–72.8 kcal/mol) and **production molecular dynamics** (OpenMM 8.6, Sage 2.1.0 valence + MMFF94 charges, GBSA/OBC2, 300 K, 200 ps) — labeling the fourth dimension that 2D GNNs cannot see. See [`DYNAMICS_REPORT_EN.md`](../../projects/phase02/reports/DYNAMICS_REPORT_EN.md) / [`DYNAMICS_REPORT_ZH.md`](../../projects/phase02/reports/DYNAMICS_REPORT_ZH.md).

**Phase 3 — Macromolecular frontier.** Target-bound biophysics on **KRAS G12D** (PDB 7RPZ, 1.30 Å, MRTX1133 co-crystal; the spec's "7E27" ID was erratum-verified against RCSB): pdbfixer curation, Phase-2 covalent core **T04 docked by Vina** (−7.92 kcal/mol), 50 ps complex MD (Amber14SB + Sage/AM1-BCC splice, OBC2 + 0.15 M, 310 K, Cα k = 5 kcal/mol/Å²), residue-decomposed **MM-GBSA** (ΔG_bind = −143.5 ± 2.9 kcal/mol; **His95 / Tyr96 / Glu62 / Asp12(G12D)** dominate — the textbook switch-II-pocket contacts), and the **classical-vs-ML force-field clash** on the frozen pose (Sage+AM1-BCC & MMFF94 vs ANI-2x: discrepancy concentrated on the aminopyrimidine core and acrylamide warhead, ⟨‖ΔF‖⟩ up to 81 kcal/mol/Å per moiety). See [`COMPLEX_DYNAMICS_REPORT_EN.md`](../../projects/phase03/reports/COMPLEX_DYNAMICS_REPORT_EN.md) / [`COMPLEX_DYNAMICS_REPORT_ZH.md`](../../projects/phase03/reports/COMPLEX_DYNAMICS_REPORT_ZH.md).
...
| 🇬🇧 Complex dynamics report (Phase 3) | [`COMPLEX_DYNAMICS_REPORT_EN.md`](../../projects/phase03/reports/COMPLEX_DYNAMICS_REPORT_EN.md) |
| 🇨🇳 复合物动力学报告（第三阶段） | [`COMPLEX_DYNAMICS_REPORT_ZH.md`](../../projects/phase03/reports/COMPLEX_DYNAMICS_REPORT_ZH.md) |
| Complex pipeline (Phase 3) | [`run_phase3_complex_dynamics.py`](../../projects/phase03/code/run_phase3_complex_dynamics.py) |
...
| 🇬🇧 World-model report (Phase 5) | [`WORLD_MODEL_REPORT_EN.md`](../../projects/phase05/reports/WORLD_MODEL_REPORT_EN.md) |
| 🇨🇳 世界模型报告（第五阶段） | [`WORLD_MODEL_REPORT_ZH.md`](../../projects/phase05/reports/WORLD_MODEL_REPORT_ZH.md) |
| Phase 5 world-model pipeline | [`run_phase5_chemical_world_model.py`](../../projects/phase05/code/run_phase5_chemical_world_model.py) |
| Phase 5 machine-readable results | [`results_phase5/phase5_results.json`](../../projects/phase05/results/phase5_results.json) |
| 🇬🇧 Metadynamics report (Phase 6) | [`METADYNAMICS_REPORT_EN.md`](../../projects/phase06/reports/METADYNAMICS_REPORT_EN.md) |
| 🇨🇳 元动力学报告（第六阶段） | [`METADYNAMICS_REPORT_ZH.md`](../../projects/phase06/reports/METADYNAMICS_REPORT_ZH.md) |
| Metadynamics pipeline (Phase 6) | [`run_phase6_explicit_metadynamics.py`](../../projects/phase06/code/run_phase6_explicit_metadynamics.py) |
...
| Phase 4 reaction-mechanism pipeline | [`run_phase4_reaction_mechanism.py`](../../projects/phase04/code/run_phase4_reaction_mechanism.py) |
| 🇬🇧 Skeletal editing report (Phase 4) | [`SKELETAL_EDITING_REPORT_EN.md`](../../projects/phase04/reports/SKELETAL_EDITING_REPORT_EN.md) |
| 🇨🇳 骨架编辑报告（第四阶段） | [`SKELETAL_EDITING_REPORT_ZH.md`](../../projects/phase04/reports/SKELETAL_EDITING_REPORT_ZH.md) |
| Reaction pipeline (Phase 4) | [`run_phase4_reaction_mechanism.py`](../../projects/phase04/code/run_phase4_reaction_mechanism.py) |
...
| 🇬🇧 Frontier epistemic report (Phase 7) | [`FRONTIER_EPISTEMIC_REPORT_EN.md`](../../projects/phase07/reports/FRONTIER_EPISTEMIC_REPORT_EN.md) |
| 🇨🇳 前沿认识论报告（第七阶段） | [`FRONTIER_EPISTEMIC_REPORT_ZH.md`](../../projects/phase07/reports/FRONTIER_EPISTEMIC_REPORT_ZH.md) |
| Strong-correlation wall pipeline (Phase 7) | [`run_phase7_strong_correlation_wall.py`](../../projects/phase07/code/run_phase7_strong_correlation_wall.py) |
| Phase 7 wall-of-sighs record / table | `results_phase7/phase7_results.json`, `results_phase7/phase7_scan_summary.csv` |
| 🇬🇧 Photochemistry report (Phase 8) | [`PHOTOCHEMISTRY_REPORT_EN.md`](../../projects/phase08/reports/PHOTOCHEMISTRY_REPORT_EN.md) |
| 🇨🇳 光化学报告（第八阶段） | [`PHOTOCHEMISTRY_REPORT_ZH.md`](../../projects/phase08/reports/PHOTOCHEMISTRY_REPORT_ZH.md) |
| Photodynamics pipeline (Phase 8) | [`run_phase8_photochemical_dynamics.py`](../../projects/phase08/code/run_phase8_photochemical_dynamics.py) |
...
| 🇬🇧 Self-driving lab report (Phase 9) | [`SELF_DRIVING_LAB_REPORT_EN.md`](../../projects/phase09/reports/SELF_DRIVING_LAB_REPORT_EN.md) |
| 🇨🇳 自驱动实验室报告（第九阶段） | [`SELF_DRIVING_LAB_REPORT_ZH.md`](../../projects/phase09/reports/SELF_DRIVING_LAB_REPORT_ZH.md) |
| Self-driving lab compiler (Phase 9) | [`run_phase9_self_driving_lab_compiler.py`](../../projects/phase09/code/run_phase9_self_driving_lab_compiler.py) |
| Compiled OT-2 protocol (root artifact) | [`output_ot2_protocol.py`](../../projects/phase09/code/output_ot2_protocol.py) |
...
| 🇬🇧 Flow cyber-physical report (Phase 10) | [`FLOW_CYBERPHYSICAL_REPORT_EN.md`](../../projects/phase10/reports/FLOW_CYBERPHYSICAL_REPORT_EN.md) |
| 🇨🇳 流程信息物理 twin 报告（第十阶段） | [`FLOW_CYBERPHYSICAL_REPORT_ZH.md`](../../projects/phase10/reports/FLOW_CYBERPHYSICAL_REPORT_ZH.md) |
| Continuous-flow digital twin pipeline (Phase 10) | [`run_phase10_cyberphysical_flow_twin.py`](../../projects/phase10/code/run_phase10_cyberphysical_flow_twin.py) |
...
| 🇬🇧 Neural-wavefunction VMC report (Phase 11) | [`NEURAL_WAVEFUNCTION_REPORT_EN.md`](../../projects/phase11/reports/NEURAL_WAVEFUNCTION_REPORT_EN.md) |
| 🇨🇳 神经波函数 VMC 报告（第十一阶段） | [`NEURAL_WAVEFUNCTION_REPORT_ZH.md`](../../projects/phase11/reports/NEURAL_WAVEFUNCTION_REPORT_ZH.md) |
| Neural-QMC pipeline (Phase 11) | [`run_phase11_neural_wavefunction_vmc.py`](../../projects/phase11/code/run_phase11_neural_wavefunction_vmc.py) |
...
| 🇬🇧 Bioinorganic PCET report (Phase 13) | [`PCET_METALLOENZYME_REPORT_EN.md`](../../projects/phase13/reports/PCET_METALLOENZYME_REPORT_EN.md) |
| 🇨🇳 生物无机 PCET 报告（第十三阶段） | [`PCET_METALLOENZYME_REPORT_ZH.md`](../../projects/phase13/reports/PCET_METALLOENZYME_REPORT_ZH.md) |
| PCET quantum engine (Phase 13) | [`run_phase13_metalloenzyme_pcet_engine.py`](../../projects/phase13/code/run_phase13_metalloenzyme_pcet_engine.py) |
| Phase 13 record / wavefunctions / grids / spectra | `results_phase13/phase13_results.json`, `results_phase13/a1_ferryl_m*.npz`, `results_phase13/b1_proton_pes.npz`, `results_phase13/c1_waterwire.npz`, `results_phase13/d1_epr.npz`, `results_phase13/d2_moessbauer.npz` |
| Phase 13 figures (300 DPI) | `figures_phase13/fig1_active_site_orbital_spin.png`, `figures_phase13/fig2_proton_tunneling_wavefunctions.png`, `figures_phase13/fig3_analytical_spectroscopic_twin.png` |
| 🇬🇧 Active-condensate report (Phase 14) | [`BIOMOLECULAR_CONDENSATE_REPORT_EN.md`](../../projects/phase14/reports/BIOMOLECULAR_CONDENSATE_REPORT_EN.md) |
| 🇨🇳 活性生物分子凝聚体报告（第十四阶段） | [`BIOMOLECULAR_CONDENSATE_REPORT_ZH.md`](../../projects/phase14/reports/BIOMOLECULAR_CONDENSATE_REPORT_ZH.md) |
| Active Cahn-Hilliard LLPS pipeline (Phase 14) | [`run_phase14_active_matter_condensate_phase_separation.py`](../../projects/phase14/code/run_phase14_active_matter_condensate_phase_separation.py) |
...
| 🇬🇧 Scientific-AGI manifesto (Phase 12) | [`SCIENTIFIC_AGI_MANIFESTO_EN.md`](../../projects/phase12/reports/SCIENTIFIC_AGI_MANIFESTO_EN.md) |
| 🇨🇳 科学 AGI 宣言（第十二阶段） | [`SCIENTIFIC_AGI_MANIFESTO_ZH.md`](../../projects/phase12/reports/SCIENTIFIC_AGI_MANIFESTO_ZH.md) |
| Hamiltonian law-discovery pipeline (Phase 12) | [`run_phase12_hamiltonian_law_discovery.py`](../../projects/phase12/code/run_phase12_hamiltonian_law_discovery.py) |
...
| 🇬🇧 Quantum-biology report (Phase 15) | [`QUANTUM_BIOLOGY_REPORT_EN.md`](../../projects/phase15/reports/QUANTUM_BIOLOGY_REPORT_EN.md) |
| 🇨🇳 量子生物报告（第十五阶段） | [`QUANTUM_BIOLOGY_REPORT_ZH.md`](../../projects/phase15/reports/QUANTUM_BIOLOGY_REPORT_ZH.md) |
| Quantum-biology spin–allostery pipeline (Phase 15) | [`run_phase15_quantum_biology_spin_allostery.py`](../../projects/phase15/code/run_phase15_quantum_biology_spin_allostery.py) |
...
| Mega-machine / Cryo-EM report EN (Phase 16) | [`MEGAMACHINE_CRYOM_REPORT_EN.md`](../../projects/phase16/reports/MEGAMACHINE_CRYOM_REPORT_EN.md) |
| Mega-machine / Cryo-EM report ZH (Phase 16) | [`MEGAMACHINE_CRYOM_REPORT_ZH.md`](../../projects/phase16/reports/MEGAMACHINE_CRYOM_REPORT_ZH.md) |
| NPC mega-machine pipeline (Phase 16) | [`run_phase16_megamachine_cryoem_transport.py`](../../projects/phase16/code/run_phase16_megamachine_cryoem_transport.py) |
...
| 🇬🇧 Relativistic quantum report (Phase 17) | [`RELATIVISTIC_QUANTUM_REPORT_EN.md`](../../projects/phase17/reports/RELATIVISTIC_QUANTUM_REPORT_EN.md) |
| 🇨🇳 相对论量子报告（第十七阶段） | [`RELATIVISTIC_QUANTUM_REPORT_ZH.md`](../../projects/phase17/reports/RELATIVISTIC_QUANTUM_REPORT_ZH.md) |
| 4-component Dirac pipeline (Phase 17) | [`run_phase17_relativistic_actinide_quantum.py`](../../projects/phase17/code/run_phase17_relativistic_actinide_quantum.py) |
| Phase 17 record / figures | `results_phase17/phase17_results.json`, `figures_phase17/fig1-fig4` (300 DPI) |
| 🇬🇧 Whole-cell metabolism report (Phase 18) | [`WHOLE_CELL_METABOLISM_REPORT_EN.md`](../../projects/phase18/reports/WHOLE_CELL_METABOLISM_REPORT_EN.md) |
| 🇨🇳 全细胞代谢报告（第十八阶段） | [`WHOLE_CELL_METABOLISM_REPORT_ZH.md`](../../projects/phase18/reports/WHOLE_CELL_METABOLISM_REPORT_ZH.md) |
| Whole-cell tFBA pipeline (Phase 18) | [`run_phase18_wholecell_metabolic_thermodynamics.py`](../../projects/phase18/code/run_phase18_wholecell_metabolic_thermodynamics.py) |
...
| 🇬🇧 Active-inference enzyme report (Phase 19) | [`ACTIVE_INFERENCE_ENZYME_REPORT_EN.md`](../../projects/phase19/reports/ACTIVE_INFERENCE_ENZYME_REPORT_EN.md) |
| 🇨🇳 主动推理从头酶报告（第十九阶段） | [`ACTIVE_INFERENCE_ENZYME_REPORT_ZH.md`](../../projects/phase19/reports/ACTIVE_INFERENCE_ENZYME_REPORT_ZH.md) |
| Active-inference enzyme pipeline (Phase 19) | [`run_phase19_active_inference_denovo_enzyme.py`](../../projects/phase19/code/run_phase19_active_inference_denovo_enzyme.py) |
...
| Phase 23 in-materio computing pipeline | [`run_phase23_in_materio_neuromorphic_computing.py`](../../projects/phase23/code/run_phase23_in_materio_neuromorphic_computing.py) |
| Phase 23 bilingual reports | [English](../../projects/phase23/reports/IN_MATERIO_COMPUTING_REPORT_EN.md) / [中文](../../projects/phase23/reports/IN_MATERIO_COMPUTING_REPORT_ZH.md) |
| Phase 23 data, validation and 300 DPI figures | [`results_phase23/summary.json`](../../projects/phase23/results/summary.json) / [`figures_phase23/`](../../projects/phase23/figures) |

## Figure Previews

### Fig. 1 — Structural Grid (10 targets + repaired reference)

![Molecular grid](../../projects/phase01/figures/fig1_molecular_grid.png)

### Fig. 2 — Chemical Space vs. Conventional Drug-Like Space

![Chemical space](../../projects/phase01/figures/fig2_chemical_space.png)

### Fig. 3 — Structural Complexity Radar

![Complexity radar](../../projects/phase01/figures/fig3_radar_complexity.png)
...
![Torsion scans](../../projects/phase02/figures/fig1_torsion_scans.png)

**Fig. P2-2 — MD trajectories (A: RMSD, B: Rg, C: PE/KE/TE)**

![MD trajectories](../../projects/phase02/figures/fig2_md_trajectories.png)

**Fig. P2-3 — Med-chem radar (SAScore / QED / Fsp³ / TPSA / MW)**

![MedChem radar](../../projects/phase02/figures/fig3_medchem_radar.png)
...
**Figures:** [pose + pocket contacts](../../projects/phase03/figures/fig1_binding_pose_pocket.png) · [per-residue MM-GBSA](../../projects/phase03/figures/fig2_per_residue_mmgbsa.png) · [ML vs classical force gap](../../projects/phase03/figures/fig3_ml_vs_classical_ff_gap.png)
...
**Figures:** [NEB profile](../../projects/phase04/figures/fig1_neb_reaction_profile.png) · [TS imaginary mode](../../projects/phase04/figures/fig2_ts_vibrational_mode.png) · [bond evolution heatmap](../../projects/phase04/figures/fig3_bond_evolution_matrix.png)
...
**Transparency ledger:** every non-computed quantity is flagged `assigned` in [`results_phase5/phase5_results.json`](../../projects/phase05/results/phase5_results.json) (Smoluchowski k_on, oligomerization k, aromatization sink, solution-attenuated kinetic caps) — 0 silent fallbacks in the final run.

### Phase 5 Figure Previews

**Fig. P5-1 — Reaction-network topology (nodes = relative G, edges = activation barriers)**

![ARN topology](../../projects/phase05/figures/fig1_reaction_network_topology.png)

**Fig. P5-2 — Stiff microkinetics (A: 1 ns→28 h concentration dynamics, designed Cat; B: yield–ee Pareto frontier vs T)**

![Stiff microkinetics](../../projects/phase05/figures/fig2_stiff_microkinetics_profile.png)

**Fig. P5-3 — De novo catalyst docked on the cationic stereodetermining state (3D ESP field + P–O⁻···H–N⁺ NCI)**

![TS stabilization dock](../../projects/phase05/figures/fig3_ts_stabilization_dock.png)
...
**Figures:** [solvated box + first shell](../../projects/phase06/figures/fig1_explicit_solvent_box.png) · [2D FES + ΔΔG_solv(d)](../../projects/phase06/figures/fig2_2d_free_energy_surface.png) · [convergence & stability](../../projects/phase06/figures/fig3_fes_convergence_trace.png)

### Phase 6 Figure Previews

**Fig. P6-1 — cyclopropa[b]indole in its periodic TIP3P box (first solvation shell + H-bonds + ions)**

![Explicit solvent box](../../projects/phase06/figures/fig1_explicit_solvent_box.png)

**Fig. P6-2 — 2D free-energy surfaces: explicit vs implicit, with QM IDPP reference path and solvent-shift profile**

![2D FES](../../projects/phase06/figures/fig2_2d_free_energy_surface.png)

**Fig. P6-3 — FES-ascent convergence, hill accumulation, temperature stability & WT height decay**

![Convergence](../../projects/phase06/figures/fig3_fes_convergence_trace.png)
...
**Figures:** [spin contamination & ST-gap collapse](../../projects/phase07/figures/fig1_spin_contamination_profile.png) · [CASSCF natural orbitals + NOON evolution](../../projects/phase07/figures/fig2_casscf_frontier_orbitals.png) · [the Wall of Sighs discrepancy map](../../projects/phase07/figures/fig3_the_wall_of_sighs_discrepancy.png)
...
**Figures:** [UV-Vis spectrum + NTO pairs + torsion funnel](../../projects/phase08/figures/fig1_uv_vis_absorption_spectrum.png) · [CI double cone + branching plane](../../projects/phase08/figures/fig2_conical_intersection_topology.png) · [FSSH populations & quantum yields](../../projects/phase08/figures/fig3_fssh_population_trajectories.png)
...
**Figures:** [deck architecture](../../projects/phase09/figures/fig1_robotic_deck_architecture.png) · [Bayesian Pareto frontier](../../projects/phase09/figures/fig2_bayesian_pareto_frontier.png) · [in-line HPLC deconvolution](../../projects/phase09/figures/fig3_inline_hplc_deconvolution.png)
...
**Figures:** [PDE reactor profile](../../projects/phase10/figures/fig1_continuous_pde_reactor_profile.png) · [operando PAT dashboard](../../projects/phase10/figures/fig2_operando_pat_sensor_telemetry.png) · [RL control dynamics](../../projects/phase10/figures/fig3_rl_cyberphysical_control_dynamics.png) · [TEA Pareto](../../projects/phase10/figures/fig4_techno_economic_pareto_analysis.png)
...
**Figures:** [VMC convergence + dissociation curve](../../projects/phase11/figures/fig1_vmc_energy_convergence.png) · [density slice with exact Kato cusps](../../projects/phase11/figures/fig2_electron_density_slice.png) · [local-energy variance collapse](../../projects/phase11/figures/fig3_local_energy_variance.png)
...
**Figures:** [attractor reconstruction + RD field](../../projects/phase12/figures/fig1_spatiotemporal_reconstruction.png) · [Occam Pareto + arbitration + coefficient recovery](../../projects/phase12/figures/fig2_symbolic_pareto_complexity.png) · [Lyapunov funnel & Hamiltonian core](../../projects/phase12/figures/fig3_lyapunov_entropy_descent.png)

### Phase 7 Figure Previews

**Fig. P7-1 — Symmetry breaking: spin contamination & singlet–triplet gap collapse**

![Spin contamination](../../projects/phase07/figures/fig1_spin_contamination_profile.png)

**Fig. P7-2 — CASSCF(2,2) natural orbitals: fractional occupancy along the scissile bond**

![CASSCF frontier orbitals](../../projects/phase07/figures/fig2_casscf_frontier_orbitals.png)

**Fig. P7-3 — The Wall of Sighs: six theoretical lenses on one homolysis trajectory**

![Wall of sighs](../../projects/phase07/figures/fig3_the_wall_of_sighs_discrepancy.png)
...
![UV-Vis spectrum](../../projects/phase08/figures/fig1_uv_vis_absorption_spectrum.png)

**Fig. P8-2 — The S₁/S₀ conical intersection: double cone, branching plane & penalty-MECI convergence**

![Conical intersection topology](../../projects/phase08/figures/fig2_conical_intersection_topology.png)

**Fig. P8-3 — Tully-FSSH photodynamics: population decay, hop statistics & quantum yields**

![FSSH photodynamics](../../projects/phase08/figures/fig3_fssh_population_trajectories.png)
...
![Deck architecture](../../projects/phase09/figures/fig1_robotic_deck_architecture.png)

**Fig. P9-2 — 3D Bayesian Pareto frontier (Yield × E-factor × Cost) with q-EI convergence & per-round guardrail audit**

![Pareto frontier](../../projects/phase09/figures/fig2_bayesian_pareto_frontier.png)
...
![HPLC deconvolution](../../projects/phase09/figures/fig3_inline_hplc_deconvolution.png)

### Phase 10 Figure Previews

**Fig. P10-1 — Multi-scale PDE reactor profile (z vs t)**

![PDE reactor profile](../../projects/phase10/figures/fig1_continuous_pde_reactor_profile.png)

**Fig. P10-2 — Operando multi-modal PAT dashboard (Raman waterfall · UV-Vis · ΔP · thermal)**

![PAT dashboard](../../projects/phase10/figures/fig2_operando_pat_sensor_telemetry.png)

**Fig. P10-3 — RL cyber-physical control dynamics (runaway arrest)**

![RL control dynamics](../../projects/phase10/figures/fig3_rl_cyberphysical_control_dynamics.png)

**Fig. P10-4 — Techno-economic & lifecycle Pareto analysis**

![TEA Pareto](../../projects/phase10/figures/fig4_techno_economic_pareto_analysis.png)
...
![VMC energy convergence](../../projects/phase11/figures/fig1_vmc_energy_convergence.png)
...
![Electron density slice](../../projects/phase11/figures/fig2_electron_density_slice.png)

**Fig. P11-3 — Zero-variance principle: local-energy distribution collapse and σ²(E_L) trajectories on all five systems**

![Local energy variance](../../projects/phase11/figures/fig3_local_energy_variance.png)
...
![Attractor reconstruction](../../projects/phase12/figures/fig1_spatiotemporal_reconstruction.png)

**Fig. P12-2 — Occam Pareto front, replicated-experiment arbitration and coefficient recovery in the ±10 % band**

![Pareto arbitration](../../projects/phase12/figures/fig2_symbolic_pareto_complexity.png)

**Fig. P12-3 — Discovered Lyapunov entropy-dissipation funnel V ≥ 0, Ḋ map, and the conserved Hamiltonian core**

![Lyapunov funnel](../../projects/phase12/figures/fig3_lyapunov_entropy_descent.png)
...
![Radical-pair engine](../../projects/phase15/figures/fig1_radical_pair_spin_hamiltonian.png)
...
![Quantum compass dynamics](../../projects/phase15/figures/fig2_quantum_singlet_triplet_dynamics.png)
...
![Allosteric amplification](../../projects/phase15/figures/fig3_allosteric_amplification_cascade.png)

**Fig. P15-4 — Instrumentation twin: MFE recombination kinetics, ΔA(λ, t) transient map, Larmor-locked ODMR at two fields**

![MFE & ODMR instrumentation](../../projects/phase15/figures/fig4_mfe_odmr_instrumentation.png)
...
![Megasystem cryo-EM fit](../../projects/phase16/figures/fig1_megasystem_cryoem_fit.png)
...
![FG condensate density slice](../../projects/phase16/figures/fig2_fg_condensate_density_slice.png)
...
![Translocation free energy PMF](../../projects/phase16/figures/fig3_translocation_free_energy_pmf.png)

# Phase 17 — Relativistic Quantum Chemistry Figure Previews

![4-component spinor orbitals](../../projects/phase17/figures/fig1_4component_spinor_orbitals.png)

![Spin-orbit multiplet splitting](../../projects/phase17/figures/fig2_spin_orbit_multiplet_splitting.png)

![QTAIM relativistic covalency map](../../projects/phase17/figures/fig3_qtaim_relativistic_covalency_map.png)

![Relativistic foundation validation](../../projects/phase17/figures/fig4_relativistic_foundation_validation.png)
...
# Phase 17 (pure numpy/scipy/matplotlib; from-scratch 4c-Dirac engine, no PySCF needed)
python run_phase17_relativistic_actinide_quantum.py --stage all       # -> results_phase17/ + figures_phase17/ (~45 min)
python run_phase17_relativistic_actinide_quantum.py --stage atomic    # DF/NR SCF atoms + validation (checkpointed)
python run_phase17_relativistic_actinide_quantum.py --stage figures   # re-render figures from saved record
...
├── run_phase17_relativistic_actinide_quantum.py   # Phase 17: 4-component Dirac-Fock-Slater engine + Breit quadrature + Landé multiplets + QTAIM/EDA covalency
...
├── run_phase19_active_inference_denovo_enzyme.py  # Phase 19: active-inference de novo Kemp-eliminase engine (flow matching + OpenMM + QM/MM)
├── ACTIVE_INFERENCE_ENZYME_REPORT_EN.md     # Phase 19 English treatise
├── ACTIVE_INFERENCE_ENZYME_REPORT_ZH.md     # 第十九阶段中文报告
├── figures_phase19/                         # Phase 19 fig1-fig3 (300 DPI PNG)
└── results_phase19/                         # Phase 19 outputs (master JSON, champion enzyme PDBs)
...
# Phase 19 (pure numpy/scipy/matplotlib/torch(CPU) + rdkit + openmm;
#          GFN2-xTB via the xtb.exe subprocess for the QM/MM stage)
...
See [live rerun inventory](../../shared/audit/reports/PHASE1_19_RERUN_STATUS.md),
[public command/source-hash manifest](../../shared/audit/evidence/phase1_19_rerun_20260910/manifest.json), and
[Phase 1/2/9/14/18 corrections](../../shared/audit/reports/PHASE1_2_9_14_18_RERUN_NOTES.md).
