...
> 请先阅读[新首页](README.md)、[证据说明](docs/EVIDENCE.md)与对应阶段的更正记录。
...
[新增工具适用性核验](NEW_TOOL_APPLICABILITY_20260911.md)：geomeTRIC 已用于 Phase4 独立精修并通过驻点/单虚频检查（IRC 未验证）；列出新增模型与数据集的实际用途和限制。
...
| 🇬🇧 Bioinorganic PCET report (Phase 13) | [`PCET_METALLOENZYME_REPORT_EN.md`](./PCET_METALLOENZYME_REPORT_EN.md) |
| 🇨🇳 生物无机 PCET 报告（第十三阶段） | [`PCET_METALLOENZYME_REPORT_ZH.md`](./PCET_METALLOENZYME_REPORT_ZH.md) |
| PCET quantum engine (Phase 13) | [`run_phase13_metalloenzyme_pcet_engine.py`](./run_phase13_metalloenzyme_pcet_engine.py) |
...
| 🇬🇧 Active-inference enzyme report (Phase 19) | [`ACTIVE_INFERENCE_ENZYME_REPORT_EN.md`](./ACTIVE_INFERENCE_ENZYME_REPORT_EN.md) |
...
![Spin-orbit multiplet splitting](./figures_phase17/fig2_spin_orbit_multiplet_splitting.png)

![QTAIM relativistic covalency map](./figures_phase17/fig3_qtaim_relativistic_covalency_map.png)

![Relativistic foundation validation](./figures_phase17/fig4_relativistic_foundation_validation.png)
