...
Actual local continuation: [Chinese progress report](../../../../projects/phase25/reports/PHASE25_PROGRESS_ZH.md) / [English progress report](../../../../projects/phase25/reports/PHASE25_PROGRESS_EN.md). Do not regenerate prospective inputs over an active campaign.
