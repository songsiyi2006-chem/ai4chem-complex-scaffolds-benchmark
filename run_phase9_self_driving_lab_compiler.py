...
def compile_ot2_protocol(conditions: list[dict], protocol_name: str,
    ...
    em.l("remaining -= v")
    em.l("if remaining > 1e-9:")
    em.push()
    em.l("pipette.drop_tip()  # isolate stock on every split transfer")
    em.l("pipette.pick_up_tip()")
    em.pop()
    em.pop()
    ...
    for idx, c in enumerate(conditions):
        ...
        em.l("p20.drop_tip()  # never return a reaction-exposed tip to stock")
        em.l("p20.pick_up_tip()")
        ...
        em.l("p20.drop_tip()  # isolate the internal-standard stock")
        em.l("p20.pick_up_tip()")
